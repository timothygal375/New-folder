...
function searchList(list, queryString) {
    function searchCallback(string) {
        return (
            string.name.toLowerCase().includes(queryString.toLowerCase()) ||
            string.description.toLowerCase().includes(queryString.toLowerCase) ||
            string.tags.find((tag) => tag.toLowerCase().includes(queryString.toLowerCase()))
        );
    }
