...
def red_portal():
      door = input("\nYou enter the red portal and find yourself in a hallway made completely of shiny metal "
...
def front_door():
      prisoner = input("\nYou enter the door in front, and find yourself in some sort of cockpit, indicating that you're on a spaceship. The pilot remains "
              ...
              "we take with us, the MUSCLE, the GIRL, or the LOITERER?").lower()
      if prisoner == "muscle":
                large_man()
      elif prisoner == "girl":
             girl()
...
def large_man():
      direction = input("\n'Uhhhhh...the big guy,' you say. The crewman nods and uses the control "
...
def go_left_large():
      print("\nYou head left, and the large man and crewman follow. As you fly forward, you start "
...
def go_right_large():
      print("\nYou head right, and before you know it, you've entered the atmosphere of another planet. "
...
def go_front_large():
      print("\nYou head forward, and are closely followed by the crewman and the burly man. You aren't "
...
def girl():  
      direction = input("\n'How about the girl?' you say. The crewman nods and uses the control "
...
def go_left_girl():
      print("\nYou head left and the girl and crewman follow. As you fly forward, you start"
                          "to make out a creature in the distance. It is a massive, bulbous creature with five"
                          "long necks ending in hideously beautiful heads. Looking at the heads, you can tell"
                          "that each one resembles a different member of popular boy band, One Direction."
                          "However, none of the heads have mouths. The creature's only mouth lies in the center"
...
def go_front_girl():
      print("\nYou head forward, and are closely followed by the crewman and the girl. You aren't "
                              "able to make it very far when you see a massive, humanoid figure standing in space. "
                              "The creature is incomprehensibly huge. Its head is the size of a planet, but appears to "
                              "be human in every other respect. He's clutching a microphone the size of an asteroid field. "
                              "'Wonderful,' says the creature with a smile, his voice booming through the void. 'You're just in time "
...
def loiterer():
      direction = input("\n'The loiterer,' you say. The crewman nods and uses the control "
...
def go_left_loiterer():
      print("\nYou head left and the loiterer and crewman follow. As you fly forward, you start "
                          "to make out a creature in the distance. It is a massive, bulbous creature with five "
                          "long necks ending in hideously beautiful heads. Looking at the heads, you can tell "
                          "that each one resembles a different member of popular boy band, One Direction. "
                          "However, none of the heads have mouths. The creature's only mouth lies in the center "
...
def go_front_loiterer():
      print("\nYou head forward, and are closely followed by the crewman and the loiterer. You aren't "
                           "able to make it very far when you see a massive, humanoid figure standing in space. "
                            "The creature is incomprehensibly huge. Its head is the size of a planet, but appears to "
                            "be human in every other respect. He's clutching a microphone the size of an asteroid field. "
                            "'Wonderful,' says the creature with a smile, his voice booming through the void. 'You're just in time "
...
def behind():
      save = input("\nYou enter the door behind you and find a ladder leading downward. With bated breath, "
...
def save_steve():
      print("\nYou rush to Steve's side and try to lift the crates off of him. However, they're too heavy "
...
def leave_steve():
      prisoner2 = input("\nYou turn away as Steve continues to struggle behind you. 'No!' he yells. 'Don't leave me!' "
...
def large_man2():
      print("\n'Uhhhhh...the big guy,' you say. The crewman nods and uses the control "
                        ...
                        "a dashing, roguish scoundrel with a cool space vest toting a blaster pistol and his tall, hairy best "
                        ...
                        "The ship shakes again, then stops moving altogether. 'Something's grabbed us!' shouts the "
                        ...
                        "replied. Suddenly, the burly man roared and charged. Steve easily dodges his approach, gets the "
                        "burly man in a headlock, and gives him a noogie. The burly man falls to the ground, incapacitated. "
...
def blue_portal():
      way = input("\nYou enter the blue portal, and before you know it, you fall in the middle of a conference "
...
def front_way():
      print("\nYou take the door in front of you, everyone watching as you leave. You find yourself in an "
...
def behind_way():
      next = input("\nYou exit the conference room through the door behind you, the entire room watching as you "
                           ...
                           "'Yeah, basically,' you say. 'In that case, follow me,' the man says as the elevator doors "
                           ...
                           "packed. Whatever the case, you have wound up in Awkward, and it's my job to bring you home. "
...
def bus():
      print("\n'Let's take the bus,' you say. The guide nods. 'You got it. Follow me.' He gets up from his chair."
...
def train():
      stop = input("\n'Let's take the train,' you say. The guide nods. 'You got it. Follow me.' He gets up from his chair. "
                   "You follow him out the office door. 'Remember,' he says as you approach the elevator, 'expect awkward "
                   "situations. I can't tell you how many times I've run into my ex-wife.' With that, the eleveator doors "
                   "open, and the two of you walk in, exchanging brief pleasantries with the man already inside. The doors "
                   "close, and you begin your descent. You stand there quietly, humming to yourself and looking around the "
...
def this_stop():
      hide = input("\n'Let's get off here,' you say. Your guide nods, and leads you off the train. You walk around the "
...
def choose_hide():
      print("\nYou run to the building to hide. It's a laundromat, and people are coming and going with loads of "
...
def choose_run():
      print("\nYou run away from your ex, trying to take as many weird turns as possible to lose her. You wind "
...
def next_stop():     
      print("\n'Let's get off at the next stop,' you say. Your guide nods and sits back, resting in "
...
def green_portal():
      fire = input("\nYou go through the green portal, and the next thing you know, you're sitting in the stands in an Adele "
...
def go_run():
      print("\nYou run from the fire, weaving in and out of fiery raindrops. You run towards the doors at the "
...
def go_stay():
      choice = input("\nYou decide to stay in the concert hall. After all, it would be rude to leave in the "
...
def choose_wait():
      step = input("\n'Let's wait,' you say. Joseph Gordon-Levitt nods and brings the car to a stop. The "
                   ...
                   "'Why don't you just use your totem?' you ask. He grimaces and replies, 'Whoever has us trapped "
                   "here somehow understands the nature of my totem. We'll have to us other methods to differentiate "
...
def jump_off():
        print("\nYou run towards the pit and hurl yourself off. Behind you, you can hear Joseph Gordon-Levitt "
...
def stay_here():
        home = input("\nYou decide to hold your position. Bullets keep hammering into the front of the car."
...
def go_home():
       print("\n'I want to stay here,' you say. Joseph Gordon-Levitt gestures toward your front door. "
       ...
       start()
def leave_here():
       real = input("\n'Let's get out of here,' you tell Joseph Gordon-Levitt. He grins. 'You don't "
                    ...
                    "(YES/NO)").lower()
       if real == "investigate":
              print("\nUnless...it's not real. Something Joseph Gordon-Levitt said comes back to you: "
...
def choose_drive():
      print("\n'Let's keep driving,' you say. Joseph Gordon-Levitt nods and keeps driving. Suddenly, "
...
def invalid_choice():
        print()
        print("\nNice try, smart guy, but that's an invalid input. Try again. ")
        print()
